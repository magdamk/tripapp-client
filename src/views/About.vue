<template>
  <div class="about">
    ...
    <ul>
      <li>Wprowadzenie do Node.js</li>
      <li>Programowanie usług sieciowych</li>
      <li>Szkielety aplikacyjne strony klienta</li>
    </ul>
    ...
    <a href = "mailto: magdamk@protonmail.com">Email 1</a>
    <br/>
    <a href = "mailto: magdamroziuk@wp.pl">Email 2</a>
    <br/>
